...
//            ],
            ...
            [
                'title' => 'words.transaction_history',
                'router' => 'tran_history.index',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
            ...
            [
                'title' => 'words.lottery_transaction',
                'router' => 'tran_history.show',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
            ...
            [
                'title' => 'words.sports_transaction',
                'router' => 'ballcrown.show',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
            ...
            [
                'title' => 'words.ptvideo_transaction',
                'router' => 'ptvideo_transaction.index',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
            ...
            [
                'title' => 'words.hotgame_account',
                'router' => 'hotgame_account.index',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
...
//            ],           
            ...
            [
                'title' => 'words.commissions',
                'router' => 'commission.index',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
