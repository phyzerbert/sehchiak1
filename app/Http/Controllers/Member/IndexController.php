...
class IndexController extends ApiClientController
{
    ...
    public function userCenter()
    {
        ...
        $_system_notices = SystemNotice::where('on_line', 1)->orderBy('sort', 'asc')->orderBy('created_at', 'desc')->get();
        return view('member.single_info', compact('api_mod', '_system_notices'));
    }
    ...
    public function finance_center()
    {
        ...
        // dump($bank_card_list); die;
        return view('member.finance_center',compact('bank_card_list'));
    }
    ...
    public function post_drawing(Request $request)
    {
        ...
        if ($data['qk_pwd'] != $member->qk_pwd) {
            return responseWrong(__('ft.Wrong_Pin_Number'));
        }
