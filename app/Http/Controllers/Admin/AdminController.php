...
class AdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.index', compact('apis', 'today_register_count', 'today_recharge_count', 'total_register_count', 'total_recharge_sum', 'today_recharge_sum','today_dividend_count','today_dividend_sum', 'total_dividend_sum','today_drawing_count','today_drawing_sum','total_drawing_sum', 'p','chartsData'));
    }
