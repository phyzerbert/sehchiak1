...
class MemberController extends AdminBaseController
{
    ...
    public function showRechargeInfo(Request $request, $id)
    {
        ...
        $start_at = $end_at = $status = $payment_type = '';
        ...
        return view('admin.member.showRechargeInfo', compact('data', 'start_at', 'end_at', 'status', 'payment_type', 'total_recharge', 'total_diff_money', 'id'));
    }
    ...
    public function showDrawingInfo(Request $request, $id)
    {
        ...
        return view('admin.member.showDrawingInfo', compact('data', 'start_at', 'end_at', 'status', 'total_money', 'total_counter_fee', 'id'));
    }
