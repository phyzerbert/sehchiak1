                ...
                <form class="form-horizontal cmxform" name="registerForm" id="form" action="{{ route('member_daili.update', ['id' => $data->getKey()]) }}}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="agent_uri" name="agent_uri" placeholder="不需要填写 http://"  value="{{ $data->agent_uri }}"/>
                                <br><font color="red">{{__('words.point_to_domain_a')}}</font>
                                {{-- <br><br><b><font color="DarkRed">{{__('words.contact_interface_account')}}：SKYPE-</font><font color="Green">aobet.cn</font>　　<a href="http://skype.gmw.cn/down/" target="_blank" >SKYPE {{__('words.official_download_address')}}</a></b> --}}
                            </div>
                        </div>
                    </div><!-- /.box-body -->
