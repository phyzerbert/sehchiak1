...
@section('content')
    ...
    <script>
        ...
        var ue3 = UE.getEditor('editor2');
        ue.ready(function(){
            //var content = "";
            ue1.setContent(`{!! $data->content_en !!}`);
            ue2.setContent(`{!! $data->content_malaya !!}`);
            ue3.setContent(`{!! $data->content_zh_cn !!}`);
        })
                ...
                <form class="form-horizontal" id="form" action="{{ route('about.update', ['id' => $data->getKey()]) }}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <script id="editor" name="content_en" type="text/plain"></script>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="quota" class="col-sm-2 control-label">{{ __('words.content') }}</label>
                            <div class="col-sm-7">
                                <script id="editor1" name="content_malaya" type="text/plain"></script>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="quota" class="col-sm-2 control-label">{{ __('words.content') }}</label>
                            <div class="col-sm-7">
                                <script id="editor2" name="content_zh_cn" type="text/plain"></script>
                            </div>
                        </div>
                    </div><!-- /.box-body -->
