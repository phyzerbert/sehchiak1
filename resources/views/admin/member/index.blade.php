...
@section('content')
                         ...
                         <tr>
                             ...
                             <td>
                                ...
                                @if ($item->status == 0)
                                    ...
                                    <a href="#" class="btn btn-danger btn-xs btn-approve" data-id="{{$item->getKey()}}" data-value="1">{{__('words.disable')}}</a>
                                @elseif($item->status == 1)
                                    ...
                                    <a href="#" class="btn btn-success btn-xs btn-approve" data-id="{{$item->getKey()}}" data-value="0">{{__('words.enable')}}</a>
                                @endif
    ...
    <script src="{{asset('js/notification_send.js')}}"></script>
     <script>
         $(function(){
