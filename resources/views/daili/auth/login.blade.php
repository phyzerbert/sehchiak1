...
<head>
    ...
    <style>
        ...
        .lang-selector .lang-flag.active{
            border-width: 1px;
        }
    </style>
</head>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <ul class="lang-selector">
                        <li><a href="{{ URL('lang/en') }}"><img class="lang-flag @if(config('app.locale') == 'en') active @endif" id="en" src="{{asset('web/images/usa.gif')}}" title="English"></a></li>
                        <li><a href="{{ URL('lang/malaya') }}"><img class="lang-flag @if(config('app.locale') == 'malaya') active @endif" id="malaya" src="{{asset('web/images/malay.png')}}" title="Malaya"></a></li>
                        <li><a href="{{ URL('lang/zh_cn') }}"><img class="lang-flag @if(config('app.locale') == 'zh_cn') active @endif" id="zh_cn" src="{{asset('web/images/china.gif')}}" title="Chinese"></a></li>
                    </ul>
