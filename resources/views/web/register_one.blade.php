                    ...
                    <div class="line_form">
                        <form method="POST" action="{{ route('web.post_register_one') }}">
                            ...
                            <div class="line">
                                ...
                                {{--</div>--}}
                                <span class="tips"><span class="themeCr">*</span>{{ __('ft.Must_be_6to12_characters_only_letters_numbers') }}</span>
                            </div>
                            <div class="line">
                                <span class="tit">{{ __('ft.Login_Password') }}</span>
                                <input type="password" class="inp" name="password" placeholder="" maxlength="12">
                                <span class="tips"><span class="themeCr">*</span>{{ __('ft.Must_be-6to12_characters') }}</span>
                            </div>
                            <div class="line">
                            ...
                            <div class="line">
                                <span class="tit">{{ __('ft.phone_number') }}</span>
