    ...
    <div class="modal-content">
        <form method="POST" action="{{ route('member.login.post') }}">
            ...
            <div class="modal-login_form">
                ...
                <div class="modal-login_line">
                    <button class="modal-login_submit ajax-submit-btn btn-sm" type="button">{{ __('ft.log_in') }}</button>
                </div>
    ...
    <div class="header">
        <div class="w1000">
            <a href="{{ route('web.index') }}" class="logo">
                <img src="{{ $_system_config->site_logo}}" alt="" style="    max-width: 233%;width: 150%;">
            </a>
            ...
            <div class="headright">
                <div class="topbar">
                    ...
                    <a class="flag" href="{{ URL('lang/malaya') }}">
                        <img src="{{ asset('/web/images/malay.png') }}" style="display: inline; width: 28px; height: 28px;">
                    </a>
                    <span>&nbsp;</span>
                        ...
                        <div class="login" id="LoginForm">
                            <form method="POST" action="{{ route('member.login.post') }}">
                                ...
                                <a data-longtxt="忘记？" title="点击重置登录密码" data-shorttxt="？" class="lf-forget"
                                   style="position:absolute; top:62px; padding:0 6px; display:inline-block; height:20px;
                           line-height:16px; text-align:center; border:1px solid #999; background:#fff; color:#999;
                           -moz-border-radius:25px; -webkit-border-radius:25px; border-radius:25px;right:30px;"
                ...
                <ul class="menu" >
                            ...
                            <div class="con">
                                ...
                                @if(in_array('GJ', $_api_list))
                                    <a href="javascript:;"
                                       ...
                                       @else onclick="return layer.msg('{{__('ft.confirm_login')}}',{icon:6})" @endif>皇冠体育</a>
                                @endif
                                @if(in_array('SS', $_api_list))
                                    <a href="javascript:;"
                                       ...
                                       @else onclick="return layer.msg('{{__('ft.confirm_login')}}',{icon:6})" @endif>三昇体育</a>
                                @endif
                    ...
                    <li class="LS-fish @if($web_route == 'web.catchFish') on @endif">
                        <a href="{{ route('web.catchFish') }}" class="poplogin">
                            {{ __('ft.Fishing') }}
                            <!-- <span id="fishclinent" style="position: absolute; display: inline-block; margin-left: 2px; font-size: 12px; /*color: rgb(244, 179, 0);*/">{{ __('ft.new') }}!</span> -->
                        </a>
