        ...
        <div class="wrapper">
            <section id="lobby" ng-controller="LobbiesCtrl" class="ng-scope">
                <ul class="game-list" ng-init="show='mg'">
                    ...
                    @endif
                    <li game-box="png" @if($_member) onclick="javascript:window.open('{{ route('jokerweb.index') }}','','width=858,height=445')"
                    @else onclick="return layer.msg('请先登录!',{icon:6})" @endif
                    >
                        <p>JOKERWEB<span>JOKER PLAY</span></p>
                    </li>                    
                    <li game-box="png" @if($_member) onclick="javascript:window.open('{{ route('web918.index') }}','','width=924,height=445')"
                    @else onclick="return layer.msg('请先登录!',{icon:6})" @endif
                    >
                        <p>918KISS<span>918KISS PLAY</span></p>
                    </li>
                </ul>
