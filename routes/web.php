...
Route::get('/webpush', 'AccountApproved@toWebPush')->name('webpush');
...
Route::group(['namespace' => 'Web', 'middleware' => 'web.maintain'],function ($router)
{
    ...
    Route::get('/', 'IndexController@home')->name('web.index');
    Route::post('/tokenSave', 'IndexController@tokenSave') -> name('web.tokenSave');
    ...
    Route::get('Hotgames', 'IndexController@poker')->name('web.poker');
    ...
    Route::get('sports', 'IndexController@esports')->name('web.esports');
    Route::get('Esports', 'IndexController@lottory')->name('web.lottory');
    ...
    Route::get('/lottery_new', 'IndexController@lottery_new');
    Route::get('/lottery_28', 'IndexController@lottery_28');
    Route::get('/lottery_28/result', 'IndexController@lottery28_result');
    Route::get('/lottery_28/create', 'IndexController@lottery28_create');
    Route::get('/lottery_28/play', 'IndexController@lottery28_play')->name('28.play');
    Route::post('/lottery_28/setbalance', 'IndexController@lottery28_setbalance')->name('28.setbalance');

    Route::get('/ballcrown/{style}', 'IndexController@ballcrown')->name('ballcrown.index');
    Route::any('/ballcrown/play', 'IndexController@ballcrown_play')->name('ballcrown.play');
    Route::post('/ballcrown/setbalance', 'IndexController@ballcrown_setbalance')->name('ballcrown.setbalance');

    
    Route::get('/pt_video', 'IndexController@pt_video')->name('pt_video.index');
    Route::get('/pt_video/play', 'IndexController@pt_videon_play')->name('pt_video.play');
    Route::get('/pt_video/games', function(){return view('web.pt_game_list');})->name('pt_video.list');
    Route::post('/pt_video/deposit', 'IndexController@pt_video_deposit')->name('pt_video.deposit');
    Route::post('/pt_video/withdraw', 'IndexController@pt_video_withdraw')->name('pt_video.withdraw');

    Route::get('/jokerweb', 'IndexController@jokerweb')->name('jokerweb.index');
    Route::get('/jokerweb/gamelist', 'IndexController@jokerweb_gamelist')->name('jokerweb.gamelist');
    Route::get('/jokerweb/play/{gamecode}', 'IndexController@jokerweb_play')->name('jokerweb.play');
    Route::post('/jokerweb/setbalance', 'IndexController@jokerweb_setbalance')->name('jokerweb.setbalance');

    Route::get('/web918', 'IndexController@web918')->name('web918.index');
    Route::get('/web918/gamelist', 'IndexController@web918_gamelist')->name('web918.gamelist');
    Route::get('/web918/play', 'IndexController@web918_play')->name('web918.play');
    Route::post('/web918/setbalance', 'IndexController@web918_setbalance')->name('web918.setbalance');    
...
Route::group(['domain' => env('AGENT_URL'), 'prefix' => 'daili','namespace' => 'Daili'],function ($router){
    ...
    Route::group(['middleware' => ['auth.daili']], function($router){
        ...
        Route::get('member_offline/sub_members/{id}', 'MemberOfflineController@sub_index')->name('daili.sub_members');
...
// Route::group(['prefix' => 'admin','namespace' => 'Admin'],function ($router){
    ...
    Route::get('/sendNotification', 'NotificationController@sendNotification') -> name('admin.sendNotification');
    ...
    Route::group(['middleware' => ['authorize']], function($router){
        ...
        Route::get('member/checkajax', 'MemberController@checkajax')->name('member.checkajax');
        ...
        Route::get('tran_history/index', 'TransactionHistoryController@index')->name('tran_history.index');
        Route::get('tran_history/show', 'TransactionHistoryController@show')->name('tran_history.show');

        Route::get('hotgame_account/index', 'TransactionHistoryController@hotgame_account_index')->name('hotgame_account.index');
        Route::post('hotgame_account/create', 'TransactionHistoryController@hotgame_account_create')->name('hotgmae_account.create');
        Route::get('hotgame_account/multi_create', function(){return view('admin.hotgame_account.create');})->name('hotgame_account.multi_create');
        Route::post('hotgame_account/multi_save', 'TransactionHistoryController@hotgame_account_multi_save')->name('hotgmae_account.multi_save');
        Route::get('hotgame_account/release', 'TransactionHistoryController@release')->name('hotgame_account.release');

        Route::get('ballcrown_history/index', 'TransactionHistoryController@ballcrown_transaction')->name('ballcrown.show');
        Route::get('ptvideo_history/index', 'TransactionHistoryController@ptvideo_transaction')->name('ptvideo_transaction.index');

        Route::get('commission/index', 'CommissionController@index')->name('commission.index');
        Route::get('commission/downline/{level}/{topline}/{agent}', 'CommissionController@downline')->name('commission.downline');
        Route::get('commission/agent_member/{level}/{topline}/{agent}', 'CommissionController@agent_member')->name('commission.agent_member');
        Route::get('commission/auto_commission', 'CommissionController@auto_commission')->name('commission.auto_commission');
...
Route::group(['namespace' => 'Api'],function ($router){
    ...
    $router->get('api/withdraw/{amount}', 'ApiClientController@withdraw')->name('member.api.withdraw');
